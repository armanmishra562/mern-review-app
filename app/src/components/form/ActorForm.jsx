...
// Gender options for the Selector component
const genderOptions = [
...
// ActorForm component for handling actor information form
...
export default function ActorForm({
  ...
  // Update avatar for UI preview
  const updatePosterForUI = (file) => {
    const url = URL.createObjectURL(file);
    setSelectedAvatarForUI(url);
  };

  // Handle input change for actor form fields
  ...
  // Handle form submission for actor information
  ...
  // Update state based on initial state
  useEffect(() => {
    if (initialState) {
