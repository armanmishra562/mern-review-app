...
// Global variable to track the current page number for pagination
let currentPageNo = 0;
const limit = 20;

//// Main component for managing and displaying actors
export default function Actors() {
  ...
  // Function to fetch actors based on the current page number
  ...
  // Handlers for actor actions (edit, delete)
...
// displaying options (edit, delete) for actor profiles
